...
public abstract class AbstractClient implements Runnable {
    ...
    * in some circumstances when Java refuses to send data that it thinks has been sent.
	...
	protected void connectionClosed() {
		// generate a message once the connection is closed
	...
	protected void connectionException(Exception exception) {
		// generate a message in case of the server has stopped 
		System.out.println("ATTENTION - Le serveur s'est arr�te d'ecout� \n" +
                "SERVER SHUTTING DOWN!!!!! DECONNECTION EN COURS!!!!");
        quit();
    }
	...
	public void quit() {
	        try {
	            ...
	            //Ignored since the application is exiting in chatclient.
	        }
	        System.exit(0);
	    }
